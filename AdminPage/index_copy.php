			...
			<div class="col-md-6">
				<div class="panel panel-default chat">
					...
					<div class="panel-body">
						<ul>
							<?php
								$query='SELECT full_name,comment_time,comment  from comment c INNER JOIN "User_table" ur ON  c.user_id=ur.user_id';
							...
							<li class='right clearfix'><span class='chat-img pull-right'>
								...
								<div class='chat-body clearfix'>
									<div class='header'><strong class='pull-left primary-font'>".$row[0]." "."<small class='text-muted'>". $row[1] ." "."
									</small></div>
									<p>". $row[2]. "</p>
									</div>
									</li>
